...
def njetWeights(filename):
    ...
    cuts_DY = ["elZinv", "elZinv_0b", "elZinv_g1b"]
    cuts_TT = ["elmuZinv", "elmuZinv_0b", "elmuZinv_g1b"]
    selection = "ht200_dphi"
    # histo names
    hname1 = "cntNJetsPt30Eta24Zinv/DataMC_DoubleEG_nj_%(cut)s_%(selection)scntNJetsPt30Eta24ZinvcntNJetsPt30Eta24ZinvDatadata"
    hnames2 = ["cntNJetsPt30Eta24Zinv/DataMC_DoubleEG_nj_%(cut)s_%(selection)scntNJetsPt30Eta24ZinvcntNJetsPt30Eta24ZinvDYstack",
...
def systHarvest(filename):
    ...
    hClosureDY = f4.Get("nSearchBin/nSearchBinnSearchBinnSearchBinDY#rightarrow e e no e, Z eff+accsingle")
    ...
    hDYll  = f4.Get("nSearchBin/nSearchBinnSearchBinnSearchBinDY#rightarrow e e no e, Z eff+accsingle")
...
def systScalePDF(filename):
    ...
    hnScale     = f.Get("cntNJetsPt30Eta24Zinv/DataMCwwscale_DoubleEG_nj_0b_blnotagcntNJetsPt30Eta24ZinvcntNJetsPt30Eta24ZinvZ#rightarrow#nu#nu Njet+norm weightsingle")
    hnScaleUp   = f.Get("cntNJetsPt30Eta24Zinv/DataMCwwscale_DoubleEG_nj_0b_blnotagcntNJetsPt30Eta24ZinvcntNJetsPt30Eta24ZinvZ#rightarrow#nu#nu Scale weight Upsingle")
    hnScaleDown = f.Get("cntNJetsPt30Eta24Zinv/DataMCwwscale_DoubleEG_nj_0b_blnotagcntNJetsPt30Eta24ZinvcntNJetsPt30Eta24ZinvZ#rightarrow#nu#nu Scale weight Downsingle")
    hnPDF     = f.Get("cntNJetsPt30Eta24Zinv/DataMCwwpdf_DoubleEG_nj_0b_blnotagcntNJetsPt30Eta24ZinvcntNJetsPt30Eta24ZinvZ#rightarrow#nu#nu Njet+norm weightsingle")
    hnPDFUp   = f.Get("cntNJetsPt30Eta24Zinv/DataMCwwpdf_DoubleEG_nj_0b_blnotagcntNJetsPt30Eta24ZinvcntNJetsPt30Eta24ZinvZ#rightarrow#nu#nu PDF weight Upsingle")
    hnPDFDown = f.Get("cntNJetsPt30Eta24Zinv/DataMCwwpdf_DoubleEG_nj_0b_blnotagcntNJetsPt30Eta24ZinvcntNJetsPt30Eta24ZinvZ#rightarrow#nu#nu PDF weight Downsingle")
...
def extrapolationSyst(filename):
    ...
    dataName = "%(varName)s/SystPlots_DataMCw_DoubleEG_%(varLabel)s_%(cutStr)s%(varName)s%(varName)sDatadata"
    baseName = "%(varName)s/SystPlots_DataMCw_DoubleEG_%(varLabel)s_%(cutStr)s%(varName)s%(varName)s%(sample)s"
    ...
    cutLists = {"nb":[(False,  "elZinv_0b_loose0"),
                      (True,   "elZinv_1b_loose0"),
                      (True,   "elZinv_2b_loose0"),
                      (True,   "elZinv_3b_loose0")],
                "nt":[(False,  "elZinv_0t_loose0"),
                      (True,   "elZinv_1t_loose0"),
                      (True,   "elZinv_2t_loose0")],
                "met":[(False, "elZinv_met_0_100_loose0"),
                       (False, "elZinv_met_100_200_loose0"),
                       (True,  "elZinv_met_200_300_loose0"),
                       (True,  "elZinv_met_300_400_loose0"),
                       (True,  "elZinv_met_gt400_loose0")],
                "mt2":[(False, "elZinv_mt2_0_100_loose0"),
                       (False, "elZinv_mt2_100_200_loose0"),
                       (True,  "elZinv_mt2_200_300_loose0"),
                       (True,  "elZinv_mt2_300_400_loose0"),
                       (True,  "elZinv_mt2_gt400_loose0")],
                "ht":[(False,  "elZinv_ht_200_300_loose0"),
                      (False,  "elZinv_ht_300_400_loose0"),
                      (False,  "elZinv_ht_400_500_loose0"),
                      (True,   "elZinv_ht_gt500_loose0")]
                }
